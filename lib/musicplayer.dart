...
import 'package:google_maps_flutter/google_maps_flutter.dart';
import 'package:college_tour/review.dart';

// import 'audiomap_model.dart';
// export 'audiomap_model.dart';

class AudiomapWidget extends StatefulWidget {
  const AudiomapWidget({Key? key}) : super(key: key);

  @override
  _AudiomapWidgetState createState() => _AudiomapWidgetState();
}

class _AudiomapWidgetState extends State<AudiomapWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        backgroundColor: Color(0xff39414B),
        appBar: AppBar(
        ...
        body: SafeArea(
          ...
          child: Column(
            ...
            children: [
              ...
              //     playbackButtonColor: Color(0xFF0079BD),
